...
<div class="card p-4">
    ...
    <div class="row">
        ...
        <div class="col-md-6 mb-3">
            ...
            <input class="form-control" value="<?= $employee['emp_id'] ?>" readonly>
        </div>
        ...
        <div class="col-md-6 mb-3">
            ...
            <input class="form-control" value="<?= $employee['dept_name'] ?>" readonly>
        </div>

        <div class="col-md-6 mb-3">
            <label>Designation</label>
            <input class="form-control" value="<?= $employee['designation'] ?>" readonly>
        </div>

        <div class="col-md-6 mb-3">
            <label>Email</label>
            <input class="form-control" value="<?= $employee['email'] ?>" readonly>
        </div>

        <div class="col-md-6 mb-3">
            <label>Phone</label>
            <input class="form-control" value="<?= $employee['phone'] ?>" readonly>
        </div>

        <div class="col-md-6 mb-3">
            <label>Shift</label>
            <input class="form-control" value="<?= $employee['shift_name'] ?: 'No Shift' ?>" readonly>
        </div>
